...
for subdividing an arbitrary normal gap at octagonal sector boundaries.
-/

namespace WedgeSplitAlgebraV2

noncomputable section

/-- Tangent-wedge area in sine/cosine coordinates. -/
def wedge (h₀ h₁ sn cs : ℝ) : ℝ :=
  h₀ * h₁ / sn - (h₀ ^ 2 + h₁ ^ 2) * cs / (2 * sn)

/-- Exact three-line ear identity. -/
...
/-- Positive-angle consequence of the exact identity. -/
